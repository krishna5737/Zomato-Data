...
var latlng = L.latLng(12.9654907,77.5964235);
var map = L.map('map', {
    center: latlng,
    zoom: 9,
    zoomControl: false,
...
$.ajax({
    ...
    success: function (map_data) {
        for (var i = 0; i < map_data.length; i++) {
            ...
            var content = title + "</br>" + "Location: " + map_data[i].Location + "</br>" + "Rating: " + rating + "</br>" +"URL: " + map_data[i].URL;
